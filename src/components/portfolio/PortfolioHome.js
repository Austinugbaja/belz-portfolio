...
const PortfolioHome = () => {
  return (
    <section className="w-full px-32 py-10">
      ...
      <div className="w-full flex items-center gap-12 border border-[#D3E9F6] bg-[#D3E9F6] rounded-lg px-4 mt-10">
      ...
      <div className="w-full flex items-center gap-10 border border-[#FCD0D0] bg-[#FCD0D0] rounded-lg px-4 pt-5 mt-10">
        <div className="w-full">
          <img src="/images/airsyn-preview.png" alt="" />
        </div>
        <div className="space-y-6 pr-9 w-full">
          <p className="text-3xl text-[#363535] font-Montserrat font-[700] capitalize">
            airsyn
      ...
      <div className="w-full flex gap-10 border border-[#D5DEFD] bg-[#D5DEFD] rounded-lg px-4 pt-16 mt-10">
        <div className="w-full">
      ...
      <div className="w-full flex items-center gap-10 border border-[#FFDFD1] bg-[#FFDFD1] rounded-lg px-4 py-5 mt-10">
        <div className="w-full">
