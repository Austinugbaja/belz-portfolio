...
const index = () => {
  return (
    <MainLayout>
      <section className="w-full h-[90vh] amihub-hero"></section>
      ...
      <section className="w-full bg-[#D5DEFD] py-12 px-56 space-y-5">
      ...
      <section className="w-full px-56 py-10">
        ...
        <p className="text-sm text-[#626262] font-light w-full leading-7 font-Poppins pr-20 mt-9">
